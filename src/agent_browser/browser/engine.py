...
class BrowserEngine:
    ...
    def __init__(self, config: Optional[BrowserConfig] = None, profile_name: Optional[str] = None, data_dir: Optional[Path] = None):
        ...
        self._data_dir = data_dir  # AppConfig.data_path for session profiles
    ...
    async def launch(self):
        ...
        if self._profile_name:
            ...
            manager = SessionManager(self._data_dir)
